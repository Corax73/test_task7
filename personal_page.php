        ...
        <div class="row row-cols-2">
            <div class="col">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" name="name" class="form-control" id="specificSizeInputName" value="<?= $data['name'] ?>">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="number" step="1" id="phone" name="phone" class="form-control" data-mdb-input-mask="+48 999-999-999" value="<?= $data['phone'] ?>">
                        <?php if (isset($error['phone'])) {?><span class="text-danger"><?php print $error['phone']; ?></span><?php } ?>
                    </div>
                    <div class="col-sm-3">
                        <label class="visually-hidden" for="specificSizeInputName">Name</label>
                        <input type="email" name="email" class="form-control" id="specificSizeInputName" value="<?= $data['email'] ?>">
